...
def create_app():
    with gr.Blocks(title="AI HR Interviewer") as demo:
        ...
        with admin_tab:
            ...
            n_questions_input = gr.Number(label="Number of Questions", value=5)
            ...
            save_config_button.click(update_config, inputs=[n_questions_input, interview_type_input], outputs=[config_status])
