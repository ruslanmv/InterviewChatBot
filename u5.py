...
def conduct_interview(questions, language="English", history_limit=5):
    ...
    def interview_step(user_input, audio_input, history):
        ...
        """
        nonlocal current_question_index, is_interview_finished, waiting_for_answer, interview_transcript, follow_up_count
        ...
        if "?" in response_content and follow_up_count[0] < 1: # Limit to one follow-up
