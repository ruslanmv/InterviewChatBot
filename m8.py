        ...
        with gr.Blocks(css=css) as demo:
            ...
            with gr.Tab("Admin Panel", id="admin_tab"):
                with gr.Tab("Generate Questions"):
                    try:
                        # Assuming these are defined elsewhere or in backend2.py
                        from backend2 import load_json_data, PROFESSIONS_FILE, TYPES_FILE, generate_questions_manager, update_max_questions, generate_and_save_questions_from_pdf3, generate_questions_from_job_description, cleanup
