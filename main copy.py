    ...
    try:
        ...
        def start_interview_ui():
            ...
            history.append(
                (
                    None,
                    "Let's begin! Here's your first question: " + questions[0],
                )
            )
            return history, ""
        ...
        """,
            ...
            chatbot = gr.Chatbot(
                label="Interview Chat", elem_id="chatbot", height=650
            )
...
def create_manager_app():
    ...
    """,
        ...
        def show_selected_ui(role):
            if role == "Candidate":
                return gr.Column.update(visible=True), gr.Column.update(
                    visible=False
                )
            elif role == "Admin":
                return gr.Column.update(visible=False), gr.Column.update(
                    visible=True
                )
            else:
                return gr.Column.update(visible=False), gr.Column.update(
