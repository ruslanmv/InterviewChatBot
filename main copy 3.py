...
def launch_candidate_app():
    ...
    try:
        ...
        def on_enter_submit_ui(history, user_response):
            ...
            # Use the interview_func to get the next response and update history
        ...
        """,
            ...
            # Only trigger the start_interview_ui function once when the button is clicked
            start_btn.click(
                start_interview_ui, inputs=[], outputs=[chatbot]
            )

            # Use the submit_btn and user_input for answering questions
            submit_btn.click(
                on_enter_submit_ui,
            ...
            clear_btn.click(
                clear_interview_ui, inputs=[], outputs=[chatbot]
            )
