...
def create_manager_app():
    ...
    """,
        ...
        with candidate_ui:
            ...
            # Use gr.Blocks to create a self-contained UI for the candidate
            with gr.Blocks() as candidate_block:
                candidate_app = launch_candidate_app_updated()  # Call the updated function
                candidate_block.render() # Ensure the block is rendered within the main app
