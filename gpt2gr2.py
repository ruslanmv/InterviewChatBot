...
def conduct_interview(questions, language="English", history_limit=5):
    ...
    def interview_step(user_input, history):
        ...
        if user_input.lower() in ["exit", "quit"]:
            history.append((None, "Interview terminated as requested."))
        ...
        if current_question_index[0] + 1 < len(questions):
            ...
            next_question = questions[current_question_index[0]]
            history.append((None, next_question))
            return history, ""
        else:
            history.append((None, "This concludes the interview. Thank you for your responses!"))
            return history, ""
