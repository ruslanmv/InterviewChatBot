...
def conduct_interview(questions, language="English", history_limit=5):
    ...
    def interview_step(user_input, audio_input, history):
        ...
        """
        nonlocal current_question_index, is_interview_finished, interview_transcript, follow_up_count
        ...
        conversation_history.append({
            "question": questions[current_question_index[0]] if current_question_index[0] < len(questions) else "End of interview", # to handle index out of bound during final step
            "answer": user_input
        })
        ...
        #is_follow_up = "?" in response_content
        #if is_follow_up and follow_up_count[0] < 1: # Limit to one follow-up
        #    follow_up_count[0] += 1 # Increment follow-up counter
        ...
        #If no follow-up or follow-up limit reached, advance to the next main question.
